...
# NOTE: XRP/USDT volontairement exclu — test comparatif pour isoler sa
# contribution au risque de drawdown (P(DD>50%) et Sharpe P5) observé
# lors du remplacement SUI -> XRP dans la watchlist de prod.
...
async def main():
    ...
    report_path = "monte_carlo_report_no_xrp.json"
